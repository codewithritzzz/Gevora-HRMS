      ...
      <div className="workspace-cards">
        <div className="panel large-panel">
          <div className="panel-heading">
            ...
            <StatusPill status="18.5 days available" />
          </div>
          {loading ? (
        ...
        <div className="panel side-stat">
          ...
          <div className="big-stat">18.5 <small>days</small></div>
          <span>Available across your leave policies.</span>
          <div className="stat-divider" />
          <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
            <span className="muted-label">Annual leave <b style={{ float: 'right' }}>14.5</b></span>
            <span className="muted-label">Sick leave <b style={{ float: 'right' }}>4</b></span>
          </div>
        </div>
      </div>
